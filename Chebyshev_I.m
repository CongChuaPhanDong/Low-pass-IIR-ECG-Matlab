%% ================================================================
%  THIẾT KẾ BỘ LỌC SỐ IIR THÔNG THẤP - CHEBYSHEV LOẠI I
%  Low-pass IIR Digital Filter Design using Chebyshev Type I
%% ================================================================
clc; clear; close all;
...
dlgtitle = 'Thông số bộ lọc Chebyshev I IIR';
...
%% ---------------------------------------------------------------
% Chebyshev I dùng biến đổi song tuyến (bilinear transformation)
...
%% ---------------------------------------------------------------
figure('Name','Bộ lọc IIR Chebyshev I Thông Thấp', ...
...
sgtitle(sprintf('Bộ lọc IIR Thông Thấp Chebyshev I  |  N = %d  |  fs = %.0f Hz  |  fp = %.0f Hz', ...
...
sgtitle(sprintf('Mô phỏng lọc tín hiệu – Chebyshev I Low-pass IIR  |  fp = %.0f Hz', fp), ...
